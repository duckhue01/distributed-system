...
func TestReElection2A(t *testing.T) {
	...
	log.Printf("disconnect S%d", leader1)
	...
	cfg.connect(leader1)
	log.Printf("connect S%d", leader1)
	...
	log.Printf("disconnect S%d", leader2)
	log.Printf("disconnect S%d", (leader2+1)%servers)
	...
	log.Printf("connect S%d", (leader2+1)%servers)
	cfg.checkOneLeader()

	// re-join of last node shouldn't prevent leader from existing.
	cfg.connect(leader2)
	log.Printf("connect S%d", leader2)
	cfg.checkOneLeader()
